...
class WPF_User_Profile {
	...
	public function user_profile( $user ) {
		...
		<h2><?php echo wpf_logo_svg(); ?> <?php esc_html_e( 'WP Fusion', 'wp-fusion' ); ?></h2>
			...
			<table class="form-table">
				...
				<tr>
					...
					<td>
						...
						<p class="description"><?php echo sprintf( __( 'If the contact ID or tags aren\'t in sync, click here to reset the local data and look up the contact again by email address in %s.', 'wp-fusion' ), esc_html( wp_fusion()->crm->name ) ); ?></p>
