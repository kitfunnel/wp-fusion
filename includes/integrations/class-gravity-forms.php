...
class WPF_GForms_Integration extends GFFeedAddOn {
	...
	public function init() {
		...
		add_filter( 'gform_entry_post_save', array( $this, 'maybe_process_feed' ), 5, 2 );
	...
	public function settings_wpf_fields( $field ) {
		...
		echo '<a href="wpfusion.com/documentation/lead-generation/gravity-forms" target="_blank">' . esc_html__( 'View documentation', 'wp-fusion' ) . ' &rarr;</a>';
