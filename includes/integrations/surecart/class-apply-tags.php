...
class Apply_Tags extends IntegrationService implements IntegrationInterface, PurchaseSyncInterface {
	...
	public function getLabel() {
		return sprintf( __( 'Apply %1$ss in %2$s', 'wp-fusion' ), ucwords( wpf_get_option( 'crm_tag_type', 'Tag' ) ), wp_fusion()->crm->name );
	}
	...
	public function getItemLabel() {
		return sprintf( __( 'Apply %1$ss', 'wp-fusion' ), ucwords( wpf_get_option( 'crm_tag_type', 'Tag' ) ) );
	}
	...
	public function getItemHelp() {
		return sprintf( __( 'Apply %1$ss to users', 'wp-fusion' ), wpf_get_option( 'crm_tag_type', 'Tag' ) );
	}
