...
class WPF_SendinBlue_Admin {
	...
	public function register_connection_settings( $settings, $options ) {
		...
		$new_settings['sendinblue_header'] = array(
			'title'   => __( 'Brevo Configuration', 'wp-fusion' ),
			'type'    => 'heading',
			'section' => 'setup',
		);
	...
	public function register_settings( $settings, $options ) {
		...
		$site_tracking['site_tracking_header'] = array(
			'title'   => __( 'Sendinblue Site Tracking', 'wp-fusion' ),
		...
		$site_tracking['site_tracking'] = array(
			...
			'desc'    => __( 'Enable Sendinblue site tracking scripts.', 'wp-fusion' ),
			'type'    => 'checkbox',
			'section' => 'main',
		);
		...
		$site_tracking['site_tracking_key'] = array(
			...
			'desc'    => __( 'Your tracking <code>client_key</code> can be found in the Tracking Code <a href="https://automation.sendinblue.com/parameters" target="_blank">in the Automation settings of your Sendinblue account</a>. For example: <code>l7u0448l6oipghl8v7k92</code>', 'wp-fusion' ),
			'type'    => 'text',
			'section' => 'main',
		);
